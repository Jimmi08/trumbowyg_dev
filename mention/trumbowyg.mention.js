...
(function ($) {
    ...
    var mentionListHTML = '<div class="mention-list" ajax-selector="mention-list"></div>';
    ...
    var mentionUserInListHTML = '<a ajax="mention" {class} mention-name="{user_name}" mention-replace="{replace}">{user_name_underlined}</a>';

    // Selector for HTML body
    var mentionListSelector = '[ajax-selector="mention-list"]';
            ...
            mention: {
                init: function (trumbowyg) {
                    ...
                    $(function()
                    {
                        ...
                        $(document).on('click', 'a[ajax="mention"]', function (e) {
